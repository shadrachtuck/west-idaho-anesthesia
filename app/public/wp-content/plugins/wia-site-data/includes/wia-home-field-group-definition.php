...
function wia_site_data_get_home_fields() {
	return array_merge(
		...
		array(
			'key'                => 'field_wia_featured_providers',
			'label'              => 'Featured providers — group photo',
			'name'               => 'featured_providers',
			'type'               => 'image',
			'instructions'       => 'Optional. Team photo shown above the provider list on the homepage.',
			'return_format'      => 'id',
			'preview_size'       => 'large',
			'library'            => 'all',
			'show_in_graphql'    => true,
			'graphql_field_name' => 'featuredProviders',
		),
		),
		...
		array(
			'key'                => 'field_wia_gives_back_image',
			'label'              => 'WIA Gives Back — image',
			'name'               => 'gives_back_image',
			'type'               => 'image',
			'instructions'       => 'Optional. Photo for the WIA Gives Back section on the homepage.',
			'return_format'      => 'id',
			'preview_size'       => 'large',
			'library'            => 'all',
			'show_in_graphql'    => true,
			'graphql_field_name' => 'givesBackImage',
		),
		array(
		...
		array(
			...
			'type'            => 'textarea',
			'rows'            => 12,
			'instructions'    => 'Fallback list: one name per line, used if the “Featured providers (with photos)” repeater below is empty.',
			'default_value'   => "Ryan Lindemann\nShad Westover\nKevin Hamby\nJeff Borders\nDave Navarro\nGus Powell\nSkylar Thornton\nBlaine Fisk\nCody Gardner\nNate Steenblik",
			'show_in_graphql' => true,
		),
		array(
			'key'                => 'field_wia_team_providers',
			'label'              => 'Featured providers (with photos)',
			'name'               => 'team_providers',
			'type'               => 'repeater',
			'instructions'       => 'Add one row per provider. If this repeater has any rows, names and photos come from here instead of the plain text list above.',
			'required'           => 0,
			'layout'             => 'row',
			'button_label'       => 'Add provider',
			'min'                => 0,
			'max'                => 0,
			'collapsed'          => 'field_wia_team_provider_name',
			'show_in_graphql'    => true,
			'graphql_field_name' => 'teamProviders',
			'sub_fields'         => array(
				array(
					'key'                => 'field_wia_team_provider_name',
					'label'              => 'Name',
					'name'               => 'provider_name',
					'type'               => 'text',
					'required'           => 1,
					'show_in_graphql'    => true,
					'graphql_field_name' => 'providerName',
				),
				array(
					'key'                => 'field_wia_team_provider_photo',
					'label'              => 'Photo',
					'name'               => 'provider_photo',
					'type'               => 'image',
					'return_format'      => 'id',
					...
					'library'            => 'all',
					'show_in_graphql'    => true,
					'graphql_field_name' => 'providerPhoto',
				),
			),
		),
		array(
