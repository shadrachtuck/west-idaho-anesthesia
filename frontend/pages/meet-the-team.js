...
import { getTeamProviderRows, WIA_HOME_FALLBACK } from '../constants/wiaHomeFallback';
import TeamProviderGrid from '../components/site/TeamProviderGrid';
...
export default function MeetTheTeamPage(props) {
  ...
  const providerRows = getTeamProviderRows(w, F.teamProvidersList);
    ...
    <>
      ...
      <SiteLayout>
        <div className="min-h-screen bg-wia-cream">
          <div className="mx-auto px-4 sm:px-6 lg:px-[100px] pt-12 pb-16">
            <motion.div
            ...
            >
              ...
              <p className="text-gray-700 font-sans text-lg mb-10">{teamHeading}</p>
              <TeamProviderGrid rows={providerRows} />
            </motion.div>
          </div>
        </div>
      </SiteLayout>
